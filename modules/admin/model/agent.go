...
type Agent struct {
	*cool.Model
	...
	Logo                 string  `gorm:"column:logo;size:255;comment:logo" json:"logo"`
	...
	UserId               int     `gorm:"column:user_id;comment:用户ID 2关闭" json:"user_id"`
	Balance              float64 `gorm:"column:balance;type:decimal(20,2);default:0" json:"balance"`
}
